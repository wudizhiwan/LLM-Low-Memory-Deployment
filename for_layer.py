...
def main():
    # 设置模型路径
    model_path = "/home/szm/qwen3_17b"
    weights_dir = "split_weights"
    ...
    try:
        # 初始化测试器 - 强制使用CPU
        tester = Qwen3LayerByLayerTest(model_path, weights_dir=weights_dir, device="cpu")
        ...
        # 方法2: 生成多个token形成文本
        print("\n===== 方法2: 生成多个token形成文本 =====")
        generated_text = tester.generate_text(prompt, max_new_tokens=5)  # 减少token数量以加快测试
